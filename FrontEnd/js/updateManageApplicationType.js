const BASE_URL = "https://localhost:7223/api/ApplicationTypes";
...
const applicationTypeID = parseInt(params.get("id"));
...
async function loadApplicationType() {
    showLoading();
    try {
        const response = await fetch(`${BASE_URL}/ApplictionTypeInfo/${applicationTypeID}`);
...
async function submitUpdate() {
    ...
    try {
        const response = await fetch(`${BASE_URL}/Update/${applicationTypeID}`, {
            method: "PUT",
        ...
        setTimeout(() => {
            window.location.href = "/Sections/Applications/ManageApplicationTypes/ManageApplicationType.html";
        }, 1500);
